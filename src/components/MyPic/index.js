...
import myPic from '../../images/me_color_02.jpg';
import './style.css';
      ...
      <a href="/">
        <div className={this.props.atTop ? 'header__titleImg' : 'header__titleImg header__titleImg--scrolled'}>
          ...
          <div className='header__title'>
            ...
            <h4 className={this.props.atTop ? 'special_text' : 'special_text small_text'} style={{ marginTop: '5px', color: '#333' }}>Film Director</h4>
          </div>
        </div>
      </a>
    );
