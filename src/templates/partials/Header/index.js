  ...
  render() {
    return (
      <div className='header'>
        <p className={this.state.atTop ? 'header__looking-for-engineering' : 'header__looking-for-engineering header__looking-for-engineering--hidden'}><a href="/engineering">Looking for my <br />Software Professional portfolio?</a></p>
